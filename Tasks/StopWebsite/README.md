...
Stops a website in IIS.
 ...
 - **Website Name\*:** The name of the IIS website that will be stopped on the IIS server. The name of the website should be same as that specified in the web deploy zip package file. If a Parameter 