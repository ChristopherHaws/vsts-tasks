...
## Overview
Stops a Website and/or an Application Pool in IIS
 ...
 - **Website Name\*:** The name of the IIS website that will be stopped on the IIS server.
 - **Application Pool Name\*:** The name of the IIS Application Pool that will be stopped on the IIS server.