...
Removes a website in IIS.
 ...
 - **Website Name\*:** The name of the IIS website that will be removed from the IIS server. The name of the website should be same as that specified in the web deploy zip package file. If a Parameter 